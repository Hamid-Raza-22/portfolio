...
class StringConst {
  ...
  static const String APP_TITLE = "Hamid Raza Portfolio";
  static const String SITE_URL = "https://hamidraza.com";
  ...
  static const String EMAIL_VALUE = "hamidraza.engr@gmail.com";
  ...
  static const String DEV_EMAIL = "hamidraza.engr@gmail.com";
  ...
  static const String DEV_NAME = "Hamid Raza";
  ...
  static const String DESIGNED_BY = "Designed by Hamid Raza. ";
  static const String BUILT_BY = "Built by Hamid Raza ";

  static const String ABOUT_DEV_TEXT =
      "I'm a software engineer based in Pakistan, specializing in building high quality mobile and web applications with a strong passion for opensource work. My goal is to always build pixel perfect high performant applications that provides users with a rich experience.";

  static const String EDUCATION_TEXT =
      "I am self taught programmer who graduated from University of Sialkot with a degree in Bachelor of Science in Software Engineering. I love learning and writing computer programs.";
  //Form Hint Texts
  ...
  static const String COMPANY_2_URL = "https://shrinqPakistan.com/";
  ...
  static const String COMPANY_2_ROLE_3 =
      "Developed highly interactive mobile applications for Vodafone Pakistan using Java Android";
  ...
  static const String VYBZ_DETAIL =
      "Vybz is a very handy app for all outgoing and adventurous people. The app lists all the popular and favorites tourist sites, restaurants etc. in the country. This app was a collaboration between Hamid Raza and Joseph Cobbina (Founder, CEO of Petamindz (https://petamindz.com/)).";
  ...
  static const String FOODY_BITE_DETAIL =
      "Foodybite is a free ui kit designed by Yagnesh Pipariya and built by Hamid Raza. The goal of this project is to fast track development and inspire developers who want to build a food related app. FoodyBite was beautifully crafted with flutter. You can find the foodybite designs at https://www.behance.net/gallery/81858385/Foodybite-Free-UI-Kit-for-Adobe-XD";
  ...
  static const String BEQUIP_LOGISTICS_DETAIL =
      "B-equip is well established technical support company registered in Pakistan. The company is well versed in CAT machine repairs, troubleshooting, component change out, mid-life service and more. This website was built to show their services and portfolio.";
